	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="#" class="logo">
					<img src="{{ URL::to('/assets/img/logo/logo.png') }}" style="background-color: #fff; " width="40" height="40" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<div class="page-title-box">
			    <img src="{{ URL::to('/assets/img/logo/Lodestar-Logo.png') }}" height="40" style="margin-top: -10px" alt="">
			</div>
			<!-- /Header Title -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						<span class="user-img">
						<img src="{{ URL::to('/images/'.Auth::user()->avatar) }}" alt="{{ URL::to('/images/photo_defaults.jpg') }}">
